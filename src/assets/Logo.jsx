...
export const Logo = props => {
   return (
      ...
      >
         ...
         <path
            shapeRendering="geometricPrecision"
            d="M227.6,45l-42.3,42.3c-3.7,3.7-3.7,9.7,0,13.4l42.3,42.3c3.7,3.7,9.7,3.7,13.4,0l42.3-42.3c3.7-3.7,3.7-9.7,0-13.4L241,45C237.3,41.3,231.3,41.3,227.6,45z"
         />
      </svg>
   );
};
